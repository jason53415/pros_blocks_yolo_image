...
class Yolov8Node(LifecycleNode):
    ...
    def on_configure(self, state: LifecycleState) -> TransitionCallbackReturn:
        ...
        self._img_pub = self.create_publisher(Image, "image", 10)
    ...
    def on_activate(self, state: LifecycleState) -> TransitionCallbackReturn:
        ...
        # self.yolo.fuse()
        # self.model = self.yolo.export(format="ncnn")
        # self.yolo = self.type_to_model[self.model_type](self.model)
    ...
    def image_cb(self, msg: Image) -> None:
        ...
        if self.enable:
            ...
            self._img_pub.publish(self.cv_bridge.cv2_to_imgmsg(results.plot(), encoding=msg.encoding))
